...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BroadcastMBSSessionContextsCollectionCollectionApi = (*BroadcastMBSSessionContextsCollectionCollectionApiService)(
		&c.common,
	)
	c.IndividualBroadcastMBSSessionContextDocumentApi = (*IndividualBroadcastMBSSessionContextDocumentApiService)(
		&c.common,
	)
