...
func (r *NonUeN2InfoSubscribeRequest) SetRequestBody(
	RequestBody models.Amf_Comm_NonUeN2InfoSubscriptionCreateData,
) {
...
func (a *NonUEN2MessagesSubscriptionsCollectionCollectionApiService) NonUeN2InfoSubscribe(
	ctx context.Context,
	request *NonUeN2InfoSubscribeRequest,
) (*NonUeN2InfoSubscribeResponse, error) {
	var (
	...
	case 201:
		localVarReturnValue.Amf_Comm_NonUeN2InfoSubscriptionCreatedData = new(
			models.Amf_Comm_NonUeN2InfoSubscriptionCreatedData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Amf_Comm_NonUeN2InfoSubscriptionCreatedData,
			localVarBody,
...
func (a *NonUEN2MessagesSubscriptionsCollectionCollectionApiService) NonUeN2InfoNotify(
	ctx context.Context,
	uri string,
	request *NonUeN2InfoNotifyRequest,
) (*NonUeN2InfoNotifyResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Post")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	default:
		return &localVarReturnValue, openapi.ReportError(
			"%d is not a valid status code in NonUeN2InfoNotify",
