...
func (a *N1N2IndividualSubscriptionDocumentApiService) N1N2MessageUnSubscribe(
	ctx context.Context,
	request *N1N2MessageUnSubscribeRequest,
) (*N1N2MessageUnSubscribeResponse, error) {
	var (
	...
	default:
		return &localVarReturnValue, openapi.ReportError(
			"%d is not a valid status code in N1N2MessageUnSubscribe",
