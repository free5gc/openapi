...
func (a *NonUEN2MessageNotificationIndividualSubscriptionDocumentApiService) NonUeN2InfoUnSubscribe(
	ctx context.Context,
	request *NonUeN2InfoUnSubscribeRequest,
) (*NonUeN2InfoUnSubscribeResponse, error) {
	var (
	...
	localVarPath = strings.ReplaceAll(
		...
		openapi.StringOfValue(*request.N2NotifySubscriptionId),
	)
	...
	default:
		return &localVarReturnValue, openapi.ReportError(
			"%d is not a valid status code in NonUeN2InfoUnSubscribe",
