...
@return NonUeN2InfoUnSubscribeResponse
*/
...
func (r *NonUeN2InfoUnSubscribeRequest) SetN2NotifySubscriptionId(N2NotifySubscriptionId string) {
	r.N2NotifySubscriptionId = &N2NotifySubscriptionId
}
...
func (a *NonUEN2MessageNotificationIndividualSubscriptionDocumentApiService) NonUeN2InfoUnSubscribe(ctx context.Context, request *NonUeN2InfoUnSubscribeRequest) (*NonUeN2InfoUnSubscribeResponse, error) {
	var (
		...
		localVarReturnValue  NonUeN2InfoUnSubscribeResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/non-ue-n2-messages/subscriptions/{n2NotifySubscriptionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"n2NotifySubscriptionId"+"}", openapi.StringOfValue(*request.N2NotifySubscriptionId), -1)
	...
	case 307:
		var v NonUeN2InfoUnSubscribeError
	...
	case 503:
		...
		return nil, apiError
	default:
		return &localVarReturnValue, openapi.ReportError("%d is not a valid status code in NonUeN2InfoUnSubscribe", localVarHTTPResponse.StatusCode)
	}
}
