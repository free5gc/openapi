...
func (r *ContextCreateRequest) SetContextCreateRequest(ContextCreateRequest models.ContextCreateRequest) {
	r.ContextCreateRequest = &ContextCreateRequest
}
...
func (a *BroadcastMBSSessionContextsCollectionCollectionApiService) ContextCreate(ctx context.Context, request *ContextCreateRequest) (*ContextCreateResponse, error) {
	...
	// body params
	localVarPostBody = request.ContextCreateRequest
	...
	case 201:
		err = openapi.Deserialize(&localVarReturnValue.ContextCreateResponse201, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
...
func (a *BroadcastMBSSessionContextsCollectionCollectionApiService) ContextCreateContextStatusNotificationPost(ctx context.Context, uri string, request *ContextCreateContextStatusNotificationPostRequest) (*ContextCreateContextStatusNotificationPostResponse, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ContextCreateContextStatusNotificationPostResponse
	)
	...
	// body params
	localVarPostBody = request.NullRequest
	...
	case 204:
		return &localVarReturnValue, nil
	case 307:
		var v ContextCreateContextStatusNotificationPostError
		err = openapi.Deserialize(&v.RedirectResponse, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
	...
	case 503:
		...
		return nil, apiError
	default:
		return &localVarReturnValue, openapi.ReportError("%d is not a valid status code in ContextCreateContextStatusNotificationPost", localVarHTTPResponse.StatusCode)
	}
}
