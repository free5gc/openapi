...
// APIClient manages communication with the Nnwdaf_MLModelProvision API v1.0.0
...
type APIClient struct {
	...
	// API Services
	IndividualNWDAFMLModelProvisionSubscriptionDocumentApi *IndividualNWDAFMLModelProvisionSubscriptionDocumentApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IndividualNWDAFMLModelProvisionSubscriptionDocumentApi = (*IndividualNWDAFMLModelProvisionSubscriptionDocumentApiService)(&c.common)
