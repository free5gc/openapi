...
func TestUpdateSmContextResponse500_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse500{}
	...
	target := &UpdateSmContextResponse500{}
...
func TestUpdateSmContextResponse500_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse500{
