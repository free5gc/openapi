...
func TestUpdateSmContextRequestBody_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextRequestBody{}
	m.JsonData = &models.Smf_PDUSess_SmContextUpdateData{
	...
	target := &UpdateSmContextRequestBody{}
...
func TestUpdateSmContextRequestBody_BuildToModels(t *testing.T) {
	c := &UpdateSmContextRequestBody{
