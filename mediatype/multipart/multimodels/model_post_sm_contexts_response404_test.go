...
func TestPostSmContextsResponse404_ReadFromModels(t *testing.T) {
	m := models.PostSmContextsResponse404{}
	...
	target := &PostSmContextsResponse404{}
...
func TestPostSmContextsResponse404_BuildToModels(t *testing.T) {
	c := &PostSmContextsResponse404{
