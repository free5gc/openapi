...
func TestPostSmContextsResponse503_ReadFromModels(t *testing.T) {
	m := models.PostSmContextsResponse503{}
	...
	target := &PostSmContextsResponse503{}
...
func TestPostSmContextsResponse503_BuildToModels(t *testing.T) {
	c := &PostSmContextsResponse503{
