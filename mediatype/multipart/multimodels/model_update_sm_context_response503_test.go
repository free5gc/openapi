...
func TestUpdateSmContextResponse503_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse503{}
	...
	target := &UpdateSmContextResponse503{}
...
func TestUpdateSmContextResponse503_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse503{
