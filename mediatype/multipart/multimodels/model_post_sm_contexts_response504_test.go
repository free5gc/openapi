...
func TestPostSmContextsResponse504_ReadFromModels(t *testing.T) {
	m := models.PostSmContextsResponse504{}
	...
	target := &PostSmContextsResponse504{}
...
func TestPostSmContextsResponse504_BuildToModels(t *testing.T) {
	c := &PostSmContextsResponse504{
