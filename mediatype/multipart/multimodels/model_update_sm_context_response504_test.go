...
func TestUpdateSmContextResponse504_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse504{}
	...
	target := &UpdateSmContextResponse504{}
...
func TestUpdateSmContextResponse504_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse504{
