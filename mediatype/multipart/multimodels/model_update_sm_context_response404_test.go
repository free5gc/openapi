...
func TestUpdateSmContextResponse404_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse404{}
	...
	target := &UpdateSmContextResponse404{}
...
func TestUpdateSmContextResponse404_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse404{
