...
func TestUpdateSmContextResponse200_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse200{}
	m.JsonData = &models.Smf_PDUSess_SmContextUpdatedData{
	...
	target := &UpdateSmContextResponse200{}
...
func TestUpdateSmContextResponse200_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse200{
		JsonData: &models.Smf_PDUSess_SmContextUpdatedData{
			N1SmMsg: &models.RefToBinaryData{
				ContentId: "n1SmMsg",
			},
			N2SmInfo: &models.RefToBinaryData{
