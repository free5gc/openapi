...
func TestUpdateSmContextResponse400_ReadFromModels(t *testing.T) {
	m := models.UpdateSmContextResponse400{}
	...
	target := &UpdateSmContextResponse400{}
...
func TestUpdateSmContextResponse400_BuildToModels(t *testing.T) {
	c := &UpdateSmContextResponse400{
