...
func TestPostSmContextsResponse403_ReadFromModels(t *testing.T) {
	m := models.PostSmContextsResponse403{}
	...
	target := &PostSmContextsResponse403{}
...
func TestPostSmContextsResponse403_BuildToModels(t *testing.T) {
	c := &PostSmContextsResponse403{
