...
func TestPostSmContextsResponse400_ReadFromModels(t *testing.T) {
	m := models.PostSmContextsResponse400{}
	...
	target := &PostSmContextsResponse400{}
...
func TestPostSmContextsResponse400_BuildToModels(t *testing.T) {
	c := &PostSmContextsResponse400{
