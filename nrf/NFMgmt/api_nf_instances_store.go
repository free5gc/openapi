...
func (r *GetNFInstancesRequest) SetNfType(NfType models.Nrf_NFMgmt_NFType) {
	r.NfType = &NfType
}
...
type GetNFInstancesResponse struct {
	ETag               string
	Nrf_NFMgmt_UriList *models.Nrf_NFMgmt_UriList
}
...
func (a *NFInstancesStoreApiService) GetNFInstances(
	ctx context.Context,
	request *GetNFInstancesRequest,
) (*GetNFInstancesResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Nrf_NFMgmt_UriList = new(models.Nrf_NFMgmt_UriList)
		err = openapi.Deserialize(
			localVarReturnValue.Nrf_NFMgmt_UriList,
			localVarBody,
...
type OptionsNFInstancesResponse struct {
	...
	Nrf_NFMgmt_OptionsResponse *models.Nrf_NFMgmt_OptionsResponse
}
...
func (a *NFInstancesStoreApiService) OptionsNFInstances(
	ctx context.Context,
) (*OptionsNFInstancesResponse, error) {
	var (
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		localVarReturnValue.Nrf_NFMgmt_OptionsResponse = new(
			models.Nrf_NFMgmt_OptionsResponse,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Nrf_NFMgmt_OptionsResponse,
			localVarBody,
			localVarHTTPResponse.Header.Get("Content-Type"),
		)
		if err != nil {
