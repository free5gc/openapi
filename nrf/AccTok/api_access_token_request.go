...
func (r *AccessTokenRequestRequest) SetNfType(NfType models.Nrf_NFMgmt_NFType) {
	r.NfType = &NfType
}

func (r *AccessTokenRequestRequest) SetTargetNfType(
	TargetNfType models.Nrf_NFMgmt_NFType,
) {
	r.TargetNfType = &TargetNfType
}

func (r *AccessTokenRequestRequest) SetTargetNfInstanceId(
	TargetNfInstanceId string,
) {
	r.TargetNfInstanceId = &TargetNfInstanceId
}

func (r *AccessTokenRequestRequest) SetRequesterPlmn(
	RequesterPlmn models.PlmnId,
) {
	r.RequesterPlmn = &RequesterPlmn
}

func (r *AccessTokenRequestRequest) SetRequesterPlmnList(
	RequesterPlmnList []models.PlmnId,
) {
	r.RequesterPlmnList = RequesterPlmnList
}

func (r *AccessTokenRequestRequest) SetRequesterSnssaiList(
	RequesterSnssaiList []models.Snssai,
) {
...
func (r *AccessTokenRequestRequest) SetRequesterSnpnList(
	RequesterSnpnList []models.PlmnIdNid,
) {
...
func (r *AccessTokenRequestRequest) SetTargetSnssaiList(
	TargetSnssaiList []models.Snssai,
) {
...
func (r *AccessTokenRequestRequest) SetTargetNfServiceSetId(
	TargetNfServiceSetId string,
) {
	r.TargetNfServiceSetId = &TargetNfServiceSetId
}

func (r *AccessTokenRequestRequest) SetHnrfAccessTokenUri(
	HnrfAccessTokenUri string,
) {
	r.HnrfAccessTokenUri = &HnrfAccessTokenUri
}

func (r *AccessTokenRequestRequest) SetSourceNfInstanceId(
	SourceNfInstanceId string,
) {
...
type AccessTokenRequestResponse struct {
	...
	Pragma                    string
	Nrf_AccTok_AccessTokenRsp *models.Nrf_AccTok_AccessTokenRsp
}
...
type AccessTokenRequestError struct {
	...
	Location                  string
	Pragma                    string
	Nrf_AccTok_AccessTokenErr *models.Nrf_AccTok_AccessTokenErr
	ProblemDetails            *models.ProblemDetails
	RedirectResponse          *models.RedirectResponse
}

func (a *AccessTokenRequestApiService) AccessTokenRequest(
	ctx context.Context,
	request *AccessTokenRequestRequest,
) (*AccessTokenRequestResponse, error) {
	var (
	...
	localVarFormParams.Add(
		"grant_type",
		openapi.ParameterToString(request.GrantType, ""),
	)

	localVarFormParams.Add(
		"nfInstanceId",
		openapi.ParameterToString(request.NfInstanceId, ""),
	)

	if request.NfType != nil {
		localVarFormParams.Add(
			"nfType",
			openapi.ParameterToString(request.NfType, ""),
		)
	}
	...
	if request.TargetNfType != nil {
		localVarFormParams.Add(
			"targetNfType",
			openapi.ParameterToString(request.TargetNfType, ""),
		)
	}

	localVarFormParams.Add(
		"scope",
		openapi.ParameterToString(request.Scope, ""),
	)

	if request.TargetNfInstanceId != nil {
		localVarFormParams.Add(
			"targetNfInstanceId",
			openapi.ParameterToString(request.TargetNfInstanceId, ""),
		)
	}
	...
	if request.RequesterPlmn != nil {
		localVarFormParams.Add(
			"requesterPlmn",
			openapi.ParameterToString(request.RequesterPlmn, ""),
		)
	}
	...
	if request.RequesterPlmnList != nil {
		localVarFormParams.Add(
			"requesterPlmnList",
			openapi.ParameterToString(request.RequesterPlmnList, "multi"),
		)
	}
	...
	if request.RequesterSnssaiList != nil {
		localVarFormParams.Add(
			"requesterSnssaiList",
			openapi.ParameterToString(request.RequesterSnssaiList, "multi"),
		)
	}
	...
	if request.RequesterFqdn != nil {
		localVarFormParams.Add(
			"requesterFqdn",
			openapi.ParameterToString(request.RequesterFqdn, ""),
		)
	}
	...
	if request.RequesterSnpnList != nil {
		localVarFormParams.Add(
			"requesterSnpnList",
			openapi.ParameterToString(request.RequesterSnpnList, "multi"),
		)
	}
	...
	if request.TargetPlmn != nil {
		localVarFormParams.Add(
			"targetPlmn",
			openapi.ParameterToString(request.TargetPlmn, ""),
		)
	}
	...
	if request.TargetSnpn != nil {
		localVarFormParams.Add(
			"targetSnpn",
			openapi.ParameterToString(request.TargetSnpn, ""),
		)
	}
	...
	if request.TargetSnssaiList != nil {
		localVarFormParams.Add(
			"targetSnssaiList",
			openapi.ParameterToString(request.TargetSnssaiList, "multi"),
		)
	}
	...
	if request.TargetNsiList != nil {
		localVarFormParams.Add(
			"targetNsiList",
			openapi.ParameterToString(request.TargetNsiList, "multi"),
		)
	}
	...
	if request.TargetNfSetId != nil {
		localVarFormParams.Add(
			"targetNfSetId",
			openapi.ParameterToString(request.TargetNfSetId, ""),
		)
	}
	...
	if request.TargetNfServiceSetId != nil {
		localVarFormParams.Add(
			...
			openapi.ParameterToString(request.TargetNfServiceSetId, ""),
		)
	}
	...
	if request.HnrfAccessTokenUri != nil {
		localVarFormParams.Add(
			"hnrfAccessTokenUri",
			openapi.ParameterToString(request.HnrfAccessTokenUri, ""),
		)
	}
	...
	if request.SourceNfInstanceId != nil {
		localVarFormParams.Add(
			"sourceNfInstanceId",
			openapi.ParameterToString(request.SourceNfInstanceId, ""),
		)
	}
	...
	case 200:
		localVarReturnValue.Nrf_AccTok_AccessTokenRsp = new(
			models.Nrf_AccTok_AccessTokenRsp,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Nrf_AccTok_AccessTokenRsp,
			localVarBody,
	...
	case 400:
		var v AccessTokenRequestError
		v.Nrf_AccTok_AccessTokenErr = new(models.Nrf_AccTok_AccessTokenErr)
		err = openapi.Deserialize(
			v.Nrf_AccTok_AccessTokenErr,
			localVarBody,
			localVarHTTPResponse.Header.Get("Content-Type"),
		)
		if err != nil {
		...
		v.Cache_Control = localVarHTTPResponse.Header.Get("Cache-Control")
