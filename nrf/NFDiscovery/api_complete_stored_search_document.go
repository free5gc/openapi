...
func (a *CompleteStoredSearchDocumentApiService) RetrieveCompleteSearch(ctx context.Context, request *RetrieveCompleteSearchRequest) (*RetrieveCompleteSearchResponse, error) {
	var (
	...
	case 308:
		...
		return nil, apiError
	default:
		return &localVarReturnValue, openapi.ReportError("%d is not a valid status code in RetrieveCompleteSearch", localVarHTTPResponse.StatusCode)
	}
}
