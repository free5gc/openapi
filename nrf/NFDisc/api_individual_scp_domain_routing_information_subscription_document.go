...
func (r *ScpDomainRoutingInfoUnsubscribeRequest) SetSubscriptionID(
	SubscriptionID string,
) {
...
func (a *IndividualSCPDomainRoutingInformationSubscriptionDocumentApiService) ScpDomainRoutingInfoUnsubscribe(
	ctx context.Context,
	request *ScpDomainRoutingInfoUnsubscribeRequest,
) (*ScpDomainRoutingInfoUnsubscribeResponse, error) {
	var (
