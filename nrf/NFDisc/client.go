...
// APIClient manages communication with the NRF NFDiscovery Service API v1.2.7
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CompleteStoredSearchDocumentApi = (*CompleteStoredSearchDocumentApiService)(
		&c.common,
	)
	c.IndividualSCPDomainRoutingInformationSubscriptionDocumentApi = (*IndividualSCPDomainRoutingInformationSubscriptionDocumentApiService)(
		&c.common,
	)
	c.NFInstancesStoreApi = (*NFInstancesStoreApiService)(&c.common)
	c.SCPDomainRoutingInformationDocumentApi = (*SCPDomainRoutingInformationDocumentApiService)(
		&c.common,
	)
	c.SCPDomainRoutingInformationSubscriptionsCollectionApi = (*SCPDomainRoutingInformationSubscriptionsCollectionApiService)(
		&c.common,
	)
