...
func (a *CAGACKDocumentApiService) QueryCagAck(ctx context.Context, request *QueryCagAckRequest) (*QueryCagAckResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.CagAckData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
