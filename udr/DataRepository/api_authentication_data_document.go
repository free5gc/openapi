...
func (a *AuthenticationDataDocumentApiService) QueryAuthSubsData(ctx context.Context, request *QueryAuthSubsDataRequest) (*QueryAuthSubsDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.AuthenticationSubscription, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
