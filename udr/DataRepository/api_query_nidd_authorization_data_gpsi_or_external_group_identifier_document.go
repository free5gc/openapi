...
func (a *QueryNIDDAuthorizationDataGPSIOrExternalGroupIdentifierDocumentApiService) GetNiddAuData(ctx context.Context, request *GetNiddAuDataRequest) (*GetNiddAuDataResponse, error) {
	var (
	...
	if request.MtcProviderInformation == nil {
		return nil, openapi.ReportError("MtcProviderInformation must be non nil")
	} else {
