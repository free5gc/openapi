...
func (a *SubsToNotifyDocumentApiService) ModifysubscriptionDataSubscription(ctx context.Context, request *ModifysubscriptionDataSubscriptionRequest) (*ModifysubscriptionDataSubscriptionResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.ModifysubscriptionDataSubscriptionResponse200, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
		return &localVarReturnValue, nil
...
func (a *SubsToNotifyDocumentApiService) QuerySubscriptionDataSubscriptions(ctx context.Context, request *QuerySubscriptionDataSubscriptionsRequest) (*QuerySubscriptionDataSubscriptionsResponse, error) {
	var (
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.QuerySubscriptionDataSubscriptionsResponse200, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
		return &localVarReturnValue, nil
...
func (a *SubsToNotifyDocumentApiService) RemovesubscriptionDataSubscriptions(ctx context.Context, request *RemovesubscriptionDataSubscriptionsRequest) (*RemovesubscriptionDataSubscriptionsResponse, error) {
	var (
