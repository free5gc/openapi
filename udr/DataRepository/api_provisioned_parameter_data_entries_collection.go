...
func (a *ProvisionedParameterDataEntriesCollectionApiService) GetMultiplePPDataEntries(ctx context.Context, request *GetMultiplePPDataEntriesRequest) (*GetMultiplePPDataEntriesResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.PpDataEntryList, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
