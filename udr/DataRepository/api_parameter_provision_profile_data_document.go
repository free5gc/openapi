...
func (a *ParameterProvisionProfileDataDocumentApiService) QueryPPData(ctx context.Context, request *QueryPPDataRequest) (*QueryPPDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.PpProfileData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
