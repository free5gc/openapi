...
func (a *UEsLocationInformationDocumentApiService) QueryUeLocation(ctx context.Context, request *QueryUeLocationRequest) (*QueryUeLocationResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.UdmUecmLocationInfo, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
