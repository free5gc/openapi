...
func (a *SDMSubscriptionsCollectionApiService) CreateSdmSubscriptions(ctx context.Context, request *CreateSdmSubscriptionsRequest) (*CreateSdmSubscriptionsResponse, error) {
	var (
...
func (a *SDMSubscriptionsCollectionApiService) Querysdmsubscriptions(ctx context.Context, request *QuerysdmsubscriptionsRequest) (*QuerysdmsubscriptionsResponse, error) {
	var (
