...
func (a *EventExposureDataForAGroupDocumentApiService) QueryGroupEEData(ctx context.Context, request *QueryGroupEEDataRequest) (*QueryGroupEEDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.EeGroupProfileData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
