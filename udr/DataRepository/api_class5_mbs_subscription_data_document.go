...
func (a *Class5MBSSubscriptionDataDocumentApiService) Query5mbsData(ctx context.Context, request *Query5mbsDataRequest) (*Query5mbsDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.MbsSubscriptionData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
