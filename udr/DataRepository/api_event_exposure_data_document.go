...
func (a *EventExposureDataDocumentApiService) QueryEEData(ctx context.Context, request *QueryEEDataRequest) (*QueryEEDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.EeProfileData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
