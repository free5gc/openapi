...
func (a *ParameterProvisionDocumentApiService) GetppData(ctx context.Context, request *GetppDataRequest) (*GetppDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.PpData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
