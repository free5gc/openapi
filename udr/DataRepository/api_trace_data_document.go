...
func (a *TraceDataDocumentApiService) QueryTraceData(ctx context.Context, request *QueryTraceDataRequest) (*QueryTraceDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.TraceData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
