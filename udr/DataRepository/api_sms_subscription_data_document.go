...
func (a *SMSSubscriptionDataDocumentApiService) QuerySmsData(ctx context.Context, request *QuerySmsDataRequest) (*QuerySmsDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.SmsSubscriptionData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
