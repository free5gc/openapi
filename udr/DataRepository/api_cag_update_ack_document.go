...
func (a *CAGUpdateAckDocumentApiService) CreateCagUpdateAck(ctx context.Context, request *CreateCagUpdateAckRequest) (*CreateCagUpdateAckResponse, error) {
	var (
	...
	// body params
	localVarPostBody = request.CagAckData
