...
func (a *SMFEventGroupSubscriptionInfoDocumentApiService) CreateSmfGroupSubscriptions(ctx context.Context, request *CreateSmfGroupSubscriptionsRequest) (*CreateSmfGroupSubscriptionsResponse, error) {
	var (
