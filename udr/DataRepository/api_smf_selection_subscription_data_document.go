...
func (a *SMFSelectionSubscriptionDataDocumentApiService) QuerySmfSelectData(ctx context.Context, request *QuerySmfSelectDataRequest) (*QuerySmfSelectDataResponse, error) {
	var (
