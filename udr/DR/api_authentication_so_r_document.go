...
type CreateAuthenticationSoRRequest struct {
	UeId              *string
	RequestBody       *models.Udr_DR_SorData
...
func (r *CreateAuthenticationSoRRequest) SetRequestBody(
	RequestBody models.Udr_DR_SorData,
) {
	r.RequestBody = &RequestBody
}

func (r *CreateAuthenticationSoRRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *AuthenticationSoRDocumentApiService) CreateAuthenticationSoR(
	ctx context.Context,
	request *CreateAuthenticationSoRRequest,
) (*CreateAuthenticationSoRResponse, error) {
	var (
...
type QueryAuthSoRResponse struct {
	Udr_DR_SorData *models.Udr_DR_SorData
}

type QueryAuthSoRError struct{}

func (a *AuthenticationSoRDocumentApiService) QueryAuthSoR(
	ctx context.Context,
	request *QueryAuthSoRRequest,
) (*QueryAuthSoRResponse, error) {
	var (
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		localVarReturnValue.Udr_DR_SorData = new(models.Udr_DR_SorData)
		err = openapi.Deserialize(
			localVarReturnValue.Udr_DR_SorData,
			localVarBody,
...
func (r *UpdateAuthenticationSoRRequest) SetRequestBody(
	RequestBody []models.PatchItem,
) {
	r.RequestBody = RequestBody
}

func (r *UpdateAuthenticationSoRRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
	r.SupportedFeatures = &SupportedFeatures
}
...
func (a *AuthenticationSoRDocumentApiService) UpdateAuthenticationSoR(
	ctx context.Context,
	request *UpdateAuthenticationSoRRequest,
) (*UpdateAuthenticationSoRResponse, error) {
	var (
