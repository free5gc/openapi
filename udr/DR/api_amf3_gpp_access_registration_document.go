...
func (r *AmfContext3gppRequest) SetRequestBody(RequestBody []models.PatchItem) {
...
func (a *AMF3GPPAccessRegistrationDocumentApiService) AmfContext3gpp(
	ctx context.Context,
	request *AmfContext3gppRequest,
) (*AmfContext3gppResponse, error) {
	var (
...
func (r *CreateAmfContext3gppRequest) SetRequestBody(
	RequestBody models.Udm_UECM_Amf3GppAccessRegistration,
) {
	r.RequestBody = &RequestBody
}
...
func (a *AMF3GPPAccessRegistrationDocumentApiService) CreateAmfContext3gpp(
	ctx context.Context,
	request *CreateAmfContext3gppRequest,
) (*CreateAmfContext3gppResponse, error) {
	var (
...
func (r *QueryAmfContext3gppRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
	r.SupportedFeatures = &SupportedFeatures
}
...
func (a *AMF3GPPAccessRegistrationDocumentApiService) QueryAmfContext3gpp(
	ctx context.Context,
	request *QueryAmfContext3gppRequest,
) (*QueryAmfContext3gppResponse, error) {
	var (
