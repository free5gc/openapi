...
func (r *ModifyAuthenticationSubscriptionRequest) SetRequestBody(
	RequestBody []models.PatchItem,
) {
	r.RequestBody = RequestBody
}

func (r *ModifyAuthenticationSubscriptionRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *AuthenticationSubscriptionDocumentApiService) ModifyAuthenticationSubscription(
	ctx context.Context,
	request *ModifyAuthenticationSubscriptionRequest,
) (*ModifyAuthenticationSubscriptionResponse, error) {
	var (
