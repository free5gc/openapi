...
type CreateOrReplaceIndividualIPTVConfigurationDataRequest struct {
	...
	RequestBody     *models.Udr_DR_IptvConfigData
}

func (r *CreateOrReplaceIndividualIPTVConfigurationDataRequest) SetConfigurationId(
	ConfigurationId string,
) {
	r.ConfigurationId = &ConfigurationId
}

func (r *CreateOrReplaceIndividualIPTVConfigurationDataRequest) SetRequestBody(
	RequestBody models.Udr_DR_IptvConfigData,
) {
...
type CreateOrReplaceIndividualIPTVConfigurationDataResponse struct {
	Location              string
	Udr_DR_IptvConfigData *models.Udr_DR_IptvConfigData
}
...
func (a *IndividualIPTVConfigurationDataDocumentApiService) CreateOrReplaceIndividualIPTVConfigurationData(
	ctx context.Context,
	request *CreateOrReplaceIndividualIPTVConfigurationDataRequest,
) (*CreateOrReplaceIndividualIPTVConfigurationDataResponse, error) {
	var (
	...
	localVarPath = strings.ReplaceAll(
		localVarPath,
		"{"+"configurationId"+"}",
		openapi.StringOfValue(*request.ConfigurationId),
	)
	...
	case 201:
		localVarReturnValue.Udr_DR_IptvConfigData = new(
			models.Udr_DR_IptvConfigData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udr_DR_IptvConfigData,
			localVarBody,
...
func (r *DeleteIndividualIPTVConfigurationDataRequest) SetConfigurationId(
	ConfigurationId string,
) {
	r.ConfigurationId = &ConfigurationId
}
...
func (a *IndividualIPTVConfigurationDataDocumentApiService) DeleteIndividualIPTVConfigurationData(
	ctx context.Context,
	request *DeleteIndividualIPTVConfigurationDataRequest,
) (*DeleteIndividualIPTVConfigurationDataResponse, error) {
	var (
...
type PartialReplaceIndividualIPTVConfigurationDataRequest struct {
	ConfigurationId *string
	RequestBody     *models.Nef_IPTVConfig_IptvConfigDataPatch
}

func (r *PartialReplaceIndividualIPTVConfigurationDataRequest) SetConfigurationId(
	ConfigurationId string,
) {
	r.ConfigurationId = &ConfigurationId
}

func (r *PartialReplaceIndividualIPTVConfigurationDataRequest) SetRequestBody(
	RequestBody models.Nef_IPTVConfig_IptvConfigDataPatch,
) {
	r.RequestBody = &RequestBody
}
...
func (a *IndividualIPTVConfigurationDataDocumentApiService) PartialReplaceIndividualIPTVConfigurationData(
	ctx context.Context,
	request *PartialReplaceIndividualIPTVConfigurationDataRequest,
) (*PartialReplaceIndividualIPTVConfigurationDataResponse, error) {
	var (
