...
func (r *QuerySmsMngDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *SMSManagementSubscriptionDataDocumentApiService) QuerySmsMngData(
	ctx context.Context,
	request *QuerySmsMngDataRequest,
) (*QuerySmsMngDataResponse, error) {
	var (
