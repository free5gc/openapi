...
func (r *CreateAuthenticationStatusRequest) SetRequestBody(
	RequestBody models.Udm_UEAU_AuthEvent,
) {
...
func (a *AuthenticationStatusDocumentApiService) CreateAuthenticationStatus(
	ctx context.Context,
	request *CreateAuthenticationStatusRequest,
) (*CreateAuthenticationStatusResponse, error) {
	var (
