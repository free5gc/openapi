...
func (a *QueryAMFSubscriptionInfoDocumentApiService) GetAmfGroupSubscriptions(
	ctx context.Context,
	request *GetAmfGroupSubscriptionsRequest,
) (*GetAmfGroupSubscriptionsResponse, error) {
	var (
...
func (a *QueryAMFSubscriptionInfoDocumentApiService) GetAmfSubscriptionInfo(
	ctx context.Context,
	request *GetAmfSubscriptionInfoRequest,
) (*GetAmfSubscriptionInfoResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
