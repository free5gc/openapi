...
func (r *QueryCoverageRestrictionDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
	r.SupportedFeatures = &SupportedFeatures
}

func (r *QueryCoverageRestrictionDataRequest) SetIfNoneMatch(
	IfNoneMatch string,
) {
	r.IfNoneMatch = &IfNoneMatch
}

func (r *QueryCoverageRestrictionDataRequest) SetIfModifiedSince(
	IfModifiedSince string,
) {
...
type QueryCoverageRestrictionDataResponse struct {
	...
	Udm_SDM_EnhancedCoverageRestrictionData *models.Udm_SDM_EnhancedCoverageRestrictionData
}

type QueryCoverageRestrictionDataError struct{}

func (a *EnhancedCoverageRestrictionDataApiService) QueryCoverageRestrictionData(
	ctx context.Context,
	request *QueryCoverageRestrictionDataRequest,
) (*QueryCoverageRestrictionDataResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Udm_SDM_EnhancedCoverageRestrictionData = new(
			models.Udm_SDM_EnhancedCoverageRestrictionData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_EnhancedCoverageRestrictionData,
			localVarBody,
