...
func (a *TraceDataDocumentApiService) QueryTraceData(
	ctx context.Context,
	request *QueryTraceDataRequest,
) (*QueryTraceDataResponse, error) {
	var (
		...
		localVarReturnValue  QueryTraceDataResponse
	)
	...
	case 200:
		localVarReturnValue.TraceData = new(models.TraceData)
