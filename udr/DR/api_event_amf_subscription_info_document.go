...
func (a *EventAMFSubscriptionInfoDocumentApiService) RemoveAmfGroupSubscriptions(
	ctx context.Context,
	request *RemoveAmfGroupSubscriptionsRequest,
) (*RemoveAmfGroupSubscriptionsResponse, error) {
	var (
...
func (a *EventAMFSubscriptionInfoDocumentApiService) RemoveAmfSubscriptionsInfo(
	ctx context.Context,
	request *RemoveAmfSubscriptionsInfoRequest,
) (*RemoveAmfSubscriptionsInfoResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
