...
func (r *Query5GVNGroupPPDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
type Query5GVNGroupPPDataResponse struct {
	Udr_DR_Pp5gVnGroupProfileData *models.Udr_DR_Pp5gVnGroupProfileData
}

type Query5GVNGroupPPDataError struct{}

func (a *ParameterProvisionProfileDataFor5GVNGroupDocumentApiService) Query5GVNGroupPPData(
	ctx context.Context,
	request *Query5GVNGroupPPDataRequest,
) (*Query5GVNGroupPPDataResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Udr_DR_Pp5gVnGroupProfileData = new(
			models.Udr_DR_Pp5gVnGroupProfileData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udr_DR_Pp5gVnGroupProfileData,
			localVarBody,
