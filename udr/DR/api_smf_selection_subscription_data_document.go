...
@return QuerySmfSelectDataResponse
*/
...
func (r *QuerySmfSelectDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
type QuerySmfSelectDataResponse struct {
	...
	Udm_SDM_SmfSelectionSubscriptionData *models.Udm_SDM_SmfSelectionSubscriptionData
}

type QuerySmfSelectDataError struct{}

func (a *SMFSelectionSubscriptionDataDocumentApiService) QuerySmfSelectData(
	ctx context.Context,
	request *QuerySmfSelectDataRequest,
) (*QuerySmfSelectDataResponse, error) {
	var (
		...
		localVarReturnValue  QuerySmfSelectDataResponse
	)
	...
	case 200:
		localVarReturnValue.Udm_SDM_SmfSelectionSubscriptionData = new(
			models.Udm_SDM_SmfSelectionSubscriptionData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_SmfSelectionSubscriptionData,
			localVarBody,
