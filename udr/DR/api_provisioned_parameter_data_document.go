...
func (r *ModifyPpDataRequest) SetRequestBody(RequestBody []models.PatchItem) {
...
func (a *ProvisionedParameterDataDocumentApiService) ModifyPpData(
	ctx context.Context,
	request *ModifyPpDataRequest,
) (*ModifyPpDataResponse, error) {
	var (
