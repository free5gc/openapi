...
/*
Class5MBSSubscriptionDataDocumentApiService Retrieves the 5mbs subscription data of a UE
...
type Query5mbsDataResponse struct {
	...
	Udm_SDM_MbsSubscriptionData *models.Udm_SDM_MbsSubscriptionData
}

type Query5mbsDataError struct{}

func (a *Class5MBSSubscriptionDataDocumentApiService) Query5mbsData(
	ctx context.Context,
	request *Query5mbsDataRequest,
) (*Query5mbsDataResponse, error) {
	var (
		...
		localVarReturnValue  Query5mbsDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/subscription-data/{ueId}/5mbs-data"
	...
	case 200:
		localVarReturnValue.Udm_SDM_MbsSubscriptionData = new(
			models.Udm_SDM_MbsSubscriptionData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_MbsSubscriptionData,
			localVarBody,
