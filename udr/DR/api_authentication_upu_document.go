...
type CreateAuthenticationUPURequest struct {
	UeId              *string
	RequestBody       *models.Udr_DR_UpuData
...
func (r *CreateAuthenticationUPURequest) SetRequestBody(
	RequestBody models.Udr_DR_UpuData,
) {
	r.RequestBody = &RequestBody
}

func (r *CreateAuthenticationUPURequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *AuthenticationUPUDocumentApiService) CreateAuthenticationUPU(
	ctx context.Context,
	request *CreateAuthenticationUPURequest,
) (*CreateAuthenticationUPUResponse, error) {
	var (
...
type QueryAuthUPUResponse struct {
	Udr_DR_UpuData *models.Udr_DR_UpuData
}

type QueryAuthUPUError struct{}

func (a *AuthenticationUPUDocumentApiService) QueryAuthUPU(
	ctx context.Context,
	request *QueryAuthUPURequest,
) (*QueryAuthUPUResponse, error) {
	var (
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		localVarReturnValue.Udr_DR_UpuData = new(models.Udr_DR_UpuData)
		err = openapi.Deserialize(
			localVarReturnValue.Udr_DR_UpuData,
			localVarBody,
