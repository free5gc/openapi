...
func (a *AccessAndMobilitySubscriptionDataDocumentApiService) QueryAmData(
	ctx context.Context,
	request *QueryAmDataRequest,
) (*QueryAmDataResponse, error) {
	var (
		...
		localVarReturnValue  QueryAmDataResponse
	)
