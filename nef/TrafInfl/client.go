...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IndividualTrafficInfluenceSubscriptionApi = (*IndividualTrafficInfluenceSubscriptionApiService)(
		&c.common,
	)
	c.TrafficInfluenceSubscriptionApi = (*TrafficInfluenceSubscriptionApiService)(
		&c.common,
	)
