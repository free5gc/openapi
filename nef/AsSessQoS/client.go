...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ASSessionWithRequiredQoSSubscriptionsApi = (*ASSessionWithRequiredQoSSubscriptionsApiService)(
		&c.common,
	)
	c.IndividualASSessionWithRequiredQoSSubscriptionApi = (*IndividualASSessionWithRequiredQoSSubscriptionApiService)(
		&c.common,
	)
