...
func (r *CreateIndividualSubcriptionRequest) SetNefEventExposureSubsc(NefEventExposureSubsc models.NefEventExposureSubsc) {
...
type CreateIndividualSubcriptionMyNotificationPostRequest struct {
	NefEventExposureNotif *models.NefEventExposureNotif
}

func (r *CreateIndividualSubcriptionMyNotificationPostRequest) SetNefEventExposureNotif(NefEventExposureNotif models.NefEventExposureNotif) {
	r.NefEventExposureNotif = &NefEventExposureNotif
}
...
func (a *SubscriptionsCollectionApiService) CreateIndividualSubcriptionMyNotificationPost(ctx context.Context, uri string, request *CreateIndividualSubcriptionMyNotificationPostRequest) (*CreateIndividualSubcriptionMyNotificationPostResponse, error) {
	...
	// body params
	localVarPostBody = request.NefEventExposureNotif
