...
func (a *AMF3GppAccessRegistrationInfoRetrievalApiService) Get3GppRegistration(ctx context.Context, request *Get3GppRegistrationRequest) (*Get3GppRegistrationResponse, error) {
	var (
