...
func (a *ParameterUpdateInTheAMFRegistrationForNon3GPPAccessApiService) UpdateNon3GppRegistration(ctx context.Context, request *UpdateNon3GppRegistrationRequest) (*UpdateNon3GppRegistrationResponse, error) {
	var (
	...
	// body params
	localVarPostBody = request.AmfNon3GppAccessRegistrationModification
