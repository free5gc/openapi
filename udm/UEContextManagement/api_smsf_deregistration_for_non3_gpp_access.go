...
func (a *SMSFDeregistrationForNon3GPPAccessApiService) Non3GppSmsfDeregistration(ctx context.Context, request *Non3GppSmsfDeregistrationRequest) (*Non3GppSmsfDeregistrationResponse, error) {
	var (
