...
func (a *IPSMGWRegistrationInfoRetrievalApiService) GetIpSmGwRegistration(ctx context.Context, request *GetIpSmGwRegistrationRequest) (*GetIpSmGwRegistrationResponse, error) {
	var (
