...
func (a *SMSFRegistrationFor3GPPAccessApiService) Call3GppSmsfRegistration(ctx context.Context, request *Call3GppSmsfRegistrationRequest) (*Call3GppSmsfRegistrationResponse, error) {
	var (
...
func (a *SMSFRegistrationFor3GPPAccessApiService) Call3GppSmsfRegistrationDataRestorationNotificationPost(ctx context.Context, uri string, request *Call3GppSmsfRegistrationDataRestorationNotificationPostRequest) (*Call3GppSmsfRegistrationDataRestorationNotificationPostResponse, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  Call3GppSmsfRegistrationDataRestorationNotificationPostResponse
	)
	...
	case 204:
		return &localVarReturnValue, nil
	case 307:
		var v Call3GppSmsfRegistrationDataRestorationNotificationPostError
