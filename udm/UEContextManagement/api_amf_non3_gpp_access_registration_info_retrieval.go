...
func (a *AMFNon3GPPAccessRegistrationInfoRetrievalApiService) GetNon3GppRegistration(ctx context.Context, request *GetNon3GppRegistrationRequest) (*GetNon3GppRegistrationResponse, error) {
	var (
