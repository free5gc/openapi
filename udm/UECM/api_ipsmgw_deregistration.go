...
/*
IPSMGWDeregistrationApiService Delete the IP-SM-GW registration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param UeId - Identifier of the UE

@return IpSmGwDeregistrationResponse
*/
...
func (a *IPSMGWDeregistrationApiService) IpSmGwDeregistration(
	ctx context.Context,
	request *IpSmGwDeregistrationRequest,
) (*IpSmGwDeregistrationResponse, error) {
	var (
		...
		localVarReturnValue  IpSmGwDeregistrationResponse
	)
	...
	case 400:
		var v IpSmGwDeregistrationError
