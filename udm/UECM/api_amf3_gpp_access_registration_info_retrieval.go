...
@return Get3GppRegistrationResponse
*/
...
func (r *Get3GppRegistrationRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *AMF3GppAccessRegistrationInfoRetrievalApiService) Get3GppRegistration(
	ctx context.Context,
	request *Get3GppRegistrationRequest,
) (*Get3GppRegistrationResponse, error) {
	var (
		...
		localVarReturnValue  Get3GppRegistrationResponse
	)
	...
	case 400:
		var v Get3GppRegistrationError
