...
type SendRoutingInfoSmRequest struct {
	UeId        *string
	RequestBody *models.Udm_UECM_RoutingInfoSmRequest
}
...
func (r *SendRoutingInfoSmRequest) SetRequestBody(
	RequestBody models.Udm_UECM_RoutingInfoSmRequest,
) {
...
type SendRoutingInfoSmResponse struct {
	Udm_UECM_RoutingInfoSmResponse *models.Udm_UECM_RoutingInfoSmResponse
}
...
func (a *SendRoutingInfoSMCustomOperationApiService) SendRoutingInfoSm(
	ctx context.Context,
	request *SendRoutingInfoSmRequest,
) (*SendRoutingInfoSmResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Udm_UECM_RoutingInfoSmResponse = new(
			models.Udm_UECM_RoutingInfoSmResponse,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_UECM_RoutingInfoSmResponse,
			localVarBody,
