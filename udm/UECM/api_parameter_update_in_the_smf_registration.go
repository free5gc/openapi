...
type UpdateSmfRegistrationRequest struct {
	UeId              *string
	PduSessionId      *int32
	RequestBody       *models.Udm_UECM_SmfRegistrationModification
...
func (r *UpdateSmfRegistrationRequest) SetRequestBody(
	RequestBody models.Udm_UECM_SmfRegistrationModification,
) {
	r.RequestBody = &RequestBody
}

func (r *UpdateSmfRegistrationRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *ParameterUpdateInTheSMFRegistrationApiService) UpdateSmfRegistration(
	ctx context.Context,
	request *UpdateSmfRegistrationRequest,
) (*UpdateSmfRegistrationResponse, error) {
	var (
