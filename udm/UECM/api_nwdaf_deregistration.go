...
func (r *NwdafDeregistrationRequest) SetNwdafRegistrationId(
	NwdafRegistrationId string,
) {
...
func (a *NWDAFDeregistrationApiService) NwdafDeregistration(
	ctx context.Context,
	request *NwdafDeregistrationRequest,
) (*NwdafDeregistrationResponse, error) {
	var (
