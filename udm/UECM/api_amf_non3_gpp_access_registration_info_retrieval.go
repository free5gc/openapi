...
@return GetNon3GppRegistrationResponse
*/
...
func (r *GetNon3GppRegistrationRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *AMFNon3GPPAccessRegistrationInfoRetrievalApiService) GetNon3GppRegistration(
	ctx context.Context,
	request *GetNon3GppRegistrationRequest,
) (*GetNon3GppRegistrationResponse, error) {
	var (
		...
		localVarReturnValue  GetNon3GppRegistrationResponse
	)
	...
	case 400:
		var v GetNon3GppRegistrationError
