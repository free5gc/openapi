...
@return UpdateNon3GppRegistrationResponse
*/

// UpdateNon3GppRegistrationRequest
type UpdateNon3GppRegistrationRequest struct {
	UeId              *string
	RequestBody       *models.Udm_UECM_AmfNon3GppAccessRegistrationModification
...
func (r *UpdateNon3GppRegistrationRequest) SetRequestBody(
	RequestBody models.Udm_UECM_AmfNon3GppAccessRegistrationModification,
) {
...
func (a *ParameterUpdateInTheAMFRegistrationForNon3GPPAccessApiService) UpdateNon3GppRegistration(
	ctx context.Context,
	request *UpdateNon3GppRegistrationRequest,
) (*UpdateNon3GppRegistrationResponse, error) {
	var (
		...
		localVarReturnValue  UpdateNon3GppRegistrationResponse
	)
	...
	case 204:
		return &localVarReturnValue, nil
	case 400:
		var v UpdateNon3GppRegistrationError
