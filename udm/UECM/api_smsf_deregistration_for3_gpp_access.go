...
func (a *SMSFDeregistrationFor3GPPAccessApiService) Call3GppSmsfDeregistration(
	ctx context.Context,
	request *Call3GppSmsfDeregistrationRequest,
) (*Call3GppSmsfDeregistrationResponse, error) {
	var (
