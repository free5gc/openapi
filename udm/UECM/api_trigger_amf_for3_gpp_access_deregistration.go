...
type DeregAMFRequest struct {
	UeId        *string
	RequestBody *models.Udm_UECM_AmfDeregInfo
}
...
func (r *DeregAMFRequest) SetRequestBody(
	RequestBody models.Udm_UECM_AmfDeregInfo,
) {
...
func (a *TriggerAMFFor3GPPAccessDeregistrationApiService) DeregAMF(
	ctx context.Context,
	request *DeregAMFRequest,
) (*DeregAMFResponse, error) {
	var (
