...
@return Non3GppSmsfDeregistrationResponse
*/
...
func (a *SMSFDeregistrationForNon3GPPAccessApiService) Non3GppSmsfDeregistration(
	ctx context.Context,
	request *Non3GppSmsfDeregistrationRequest,
) (*Non3GppSmsfDeregistrationResponse, error) {
	var (
		...
		localVarReturnValue  Non3GppSmsfDeregistrationResponse
	)
	...
	case 400:
		var v Non3GppSmsfDeregistrationError
