...
type GetNSSAIResponse struct {
	...
	Udm_SDM_Nssai *models.Udm_SDM_Nssai
}
...
func (a *SliceSelectionSubscriptionDataRetrievalApiService) GetNSSAI(
	ctx context.Context,
	request *GetNSSAIRequest,
) (*GetNSSAIResponse, error) {
	var (
		...
		localVarReturnValue  GetNSSAIResponse
	)
	...
	case 200:
		localVarReturnValue.Udm_SDM_Nssai = new(models.Udm_SDM_Nssai)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_Nssai,
			localVarBody,
