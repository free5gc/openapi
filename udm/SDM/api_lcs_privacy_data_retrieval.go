...
func (r *GetLcsPrivacyDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
func (a *LCSPrivacyDataRetrievalApiService) GetLcsPrivacyData(
	ctx context.Context,
	request *GetLcsPrivacyDataRequest,
) (*GetLcsPrivacyDataResponse, error) {
	var (
