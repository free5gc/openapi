...
/*
EnhancedCoverageRestrictionDataRetrievalApiService retrieve a UE's subscribed Enhanced Coverage Restriction Data
...
func (a *EnhancedCoverageRestrictionDataRetrievalApiService) GetEcrData(
	ctx context.Context,
	request *GetEcrDataRequest,
) (*GetEcrDataResponse, error) {
	var (
		...
		localVarReturnValue  GetEcrDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/am-data/ecr-data"
