...
/*
LCSBroadcastAssistanceDataTypesRetrievalApiService retrieve a UE's LCS Broadcast Assistance Data Types Subscription Data
...
func (a *LCSBroadcastAssistanceDataTypesRetrievalApiService) GetLcsBcaData(
	ctx context.Context,
	request *GetLcsBcaDataRequest,
) (*GetLcsBcaDataResponse, error) {
	var (
		...
		localVarReturnValue  GetLcsBcaDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/lcs-bca-data"
