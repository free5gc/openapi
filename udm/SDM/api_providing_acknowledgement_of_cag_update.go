...
/*
ProvidingAcknowledgementOfCAGUpdateApiService Nudm_Sdm Info operation for CAG acknowledgement
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param Supi - Identifier of the UE
 * @param RequestBody -

@return CAGAckResponse
*/
...
func (r *CAGAckRequest) SetRequestBody(
	RequestBody models.Udm_SDM_AcknowledgeInfo,
) {
...
func (a *ProvidingAcknowledgementOfCAGUpdateApiService) CAGAck(
	ctx context.Context,
	request *CAGAckRequest,
) (*CAGAckResponse, error) {
	var (
		...
		localVarReturnValue  CAGAckResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/am-data/cag-ack"
