...
func (a *SMSSubscriptionDataRetrievalApiService) GetSmsData(
	ctx context.Context,
	request *GetSmsDataRequest,
) (*GetSmsDataResponse, error) {
	var (
		...
		localVarReturnValue  GetSmsDataResponse
	)
