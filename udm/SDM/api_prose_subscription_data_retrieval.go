...
/*
ProseSubscriptionDataRetrievalApiService retrieve a UE's ProSe Subscription Data
...
func (a *ProseSubscriptionDataRetrievalApiService) GetProseData(
	ctx context.Context,
	request *GetProseDataRequest,
) (*GetProseDataResponse, error) {
	var (
		...
		localVarReturnValue  GetProseDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/prose-data"
