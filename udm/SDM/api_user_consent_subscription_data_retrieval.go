...
func (r *GetUcDataRequest) SetUcPurpose(UcPurpose models.Udm_SDM_UcPurpose) {
...
func (a *UserConsentSubscriptionDataRetrievalApiService) GetUcData(
	ctx context.Context,
	request *GetUcDataRequest,
) (*GetUcDataResponse, error) {
	var (
