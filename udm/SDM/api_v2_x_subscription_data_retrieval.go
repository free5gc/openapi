...
/*
V2XSubscriptionDataRetrievalApiService retrieve a UE's V2X Subscription Data
...
type GetV2xDataResponse struct {
	...
	Udm_SDM_V2xSubscriptionData *models.Udm_SDM_V2xSubscriptionData
}
...
func (a *V2XSubscriptionDataRetrievalApiService) GetV2xData(
	ctx context.Context,
	request *GetV2xDataRequest,
) (*GetV2xDataResponse, error) {
	var (
		...
		localVarReturnValue  GetV2xDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/v2x-data"
	...
	case 200:
		localVarReturnValue.Udm_SDM_V2xSubscriptionData = new(
			models.Udm_SDM_V2xSubscriptionData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_V2xSubscriptionData,
			localVarBody,
