...
/*
Class5MBSSubscriptionDataRetrievalApiService retrieve a UE's 5MBS Subscription Data
...
func (a *Class5MBSSubscriptionDataRetrievalApiService) GetMbsData(
	ctx context.Context,
	request *GetMbsDataRequest,
) (*GetMbsDataResponse, error) {
	var (
		...
		localVarReturnValue  GetMbsDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/5mbs-data"
