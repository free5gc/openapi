...
type ModifyRequest struct {
	...
	RequestBody       *models.Udm_SDM_SdmSubsModification
...
func (r *ModifyRequest) SetRequestBody(
	RequestBody models.Udm_SDM_SdmSubsModification,
) {
...
func (a *SubscriptionModificationApiService) Modify(
	ctx context.Context,
	...
	case 200:
		localVarReturnValue.ModifyResponse200 = new(models.ModifyResponse200)
		err = openapi.Deserialize(
			localVarReturnValue.ModifyResponse200,
			localVarBody,
...
func (r *ModifySharedDataSubsRequest) SetRequestBody(
	RequestBody models.Udm_SDM_SdmSubsModification,
) {
	r.RequestBody = &RequestBody
}

func (r *ModifySharedDataSubsRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
	r.SupportedFeatures = &SupportedFeatures
}
...
func (a *SubscriptionModificationApiService) ModifySharedDataSubs(
	ctx context.Context,
	request *ModifySharedDataSubsRequest,
) (*ModifySharedDataSubsResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Patch")
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		localVarReturnValue.ModifySharedDataSubsResponse200 = new(
			models.ModifySharedDataSubsResponse200,
		)
		err = openapi.Deserialize(
			localVarReturnValue.ModifySharedDataSubsResponse200,
			localVarBody,
			localVarHTTPResponse.Header.Get("Content-Type"),
		)
		if err != nil {
