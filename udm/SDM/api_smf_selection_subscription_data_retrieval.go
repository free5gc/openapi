...
func (a *SMFSelectionSubscriptionDataRetrievalApiService) GetSmfSelData(
	ctx context.Context,
	request *GetSmfSelDataRequest,
) (*GetSmfSelDataResponse, error) {
	var (
		...
		localVarReturnValue  GetSmfSelDataResponse
	)
