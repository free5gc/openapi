...
func (r *SorAckInfoRequest) SetRequestBody(
	RequestBody models.Udm_SDM_AcknowledgeInfo,
) {
...
func (a *ProvidingAcknowledgementOfSteeringOfRoamingApiService) SorAckInfo(
	ctx context.Context,
	request *SorAckInfoRequest,
) (*SorAckInfoResponse, error) {
	var (
