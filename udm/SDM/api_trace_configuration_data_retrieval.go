...
func (r *GetTraceConfigDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
type GetTraceConfigDataResponse struct {
	...
	Udm_SDM_TraceDataResponse *models.Udm_SDM_TraceDataResponse
}
...
func (a *TraceConfigurationDataRetrievalApiService) GetTraceConfigData(
	ctx context.Context,
	request *GetTraceConfigDataRequest,
) (*GetTraceConfigDataResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Udm_SDM_TraceDataResponse = new(
			models.Udm_SDM_TraceDataResponse,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_TraceDataResponse,
			localVarBody,
