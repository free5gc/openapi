...
/*
LCSMobileOriginatedDataRetrievalApiService retrieve a UE's LCS Mobile Originated Subscription Data
...
func (a *LCSMobileOriginatedDataRetrievalApiService) GetLcsMoData(
	ctx context.Context,
	request *GetLcsMoDataRequest,
) (*GetLcsMoDataResponse, error) {
	var (
		...
		localVarReturnValue  GetLcsMoDataResponse
	)
	_ = localVarReturnValue

	// create path and map variables
	localVarPath := a.client.cfg.BasePath() + "/{supi}/lcs-mo-data"
