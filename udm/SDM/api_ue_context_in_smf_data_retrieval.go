...
func (r *GetUeCtxInSmfDataRequest) SetSupportedFeatures(
	SupportedFeatures string,
) {
...
type GetUeCtxInSmfDataResponse struct {
	Udm_SDM_UeContextInSmfData *models.Udm_SDM_UeContextInSmfData
}
...
func (a *UEContextInSMFDataRetrievalApiService) GetUeCtxInSmfData(
	ctx context.Context,
	request *GetUeCtxInSmfDataRequest,
) (*GetUeCtxInSmfDataResponse, error) {
	var (
	...
	case 200:
		localVarReturnValue.Udm_SDM_UeContextInSmfData = new(
			models.Udm_SDM_UeContextInSmfData,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_SDM_UeContextInSmfData,
			localVarBody,
