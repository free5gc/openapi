...
type ServiceSpecificAuthorizationRemovalRequest struct {
	...
	RequestBody *models.Udm_SSAU_ServiceSpecificAuthorizationRemoveData
}

func (r *ServiceSpecificAuthorizationRemovalRequest) SetUeIdentity(
	UeIdentity string,
) {
	r.UeIdentity = &UeIdentity
}

func (r *ServiceSpecificAuthorizationRemovalRequest) SetServiceType(
	ServiceType models.Udm_SSAU_ServiceType,
) {
	r.ServiceType = &ServiceType
}

func (r *ServiceSpecificAuthorizationRemovalRequest) SetRequestBody(
	RequestBody models.Udm_SSAU_ServiceSpecificAuthorizationRemoveData,
) {
...
func (a *ServiceSpecificAuthorizationRemoveApiService) ServiceSpecificAuthorizationRemoval(
	ctx context.Context,
	request *ServiceSpecificAuthorizationRemovalRequest,
) (*ServiceSpecificAuthorizationRemovalResponse, error) {
	var (
