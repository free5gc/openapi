 ...
 * @param UdmUeauAuthenticationInfoRequest -
...
func (r *GenerateAuthDataRequest) SetUdmUeauAuthenticationInfoRequest(UdmUeauAuthenticationInfoRequest models.UdmUeauAuthenticationInfoRequest) {
	r.UdmUeauAuthenticationInfoRequest = &UdmUeauAuthenticationInfoRequest
}
...
func (a *GenerateAuthDataApiService) GenerateAuthData(ctx context.Context, request *GenerateAuthDataRequest) (*GenerateAuthDataResponse, error) {
	...
	// body params
	localVarPostBody = request.UdmUeauAuthenticationInfoRequest
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.UdmUeauAuthenticationInfoResult, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
