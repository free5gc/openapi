...
// APIClient manages communication with the Nudm_PP API v1.2.3
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.Class5GMBSGroupCreationApi = (*Class5GMBSGroupCreationApiService)(
		&c.common,
	)
	c.Class5GMBSGroupDeletionApi = (*Class5GMBSGroupDeletionApiService)(
		&c.common,
	)
	c.Class5GMBSGroupModificationApi = (*Class5GMBSGroupModificationApiService)(
		&c.common,
	)
	...
	c.Class5GVNGroupModificationApi = (*Class5GVNGroupModificationApiService)(
		&c.common,
	)
	c.ParameterProvisioningDataEntryDocumentApi = (*ParameterProvisioningDataEntryDocumentApiService)(
		&c.common,
	)
