...
/*
Class5GVNGroupModificationApiService get 5G VN Group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ExtGroupId - External Identifier of the group

@return Get5GVNGroupResponse
*/
...
type Get5GVNGroupResponse struct {
	Udm_PP_5GVnGroupConfiguration *models.Udm_PP_5GVnGroupConfiguration
}
...
func (a *Class5GVNGroupModificationApiService) Get5GVNGroup(
	ctx context.Context,
	request *Get5GVNGroupRequest,
) (*Get5GVNGroupResponse, error) {
	var (
		...
		localVarReturnValue  Get5GVNGroupResponse
	)
	...
	case 200:
		localVarReturnValue.Udm_PP_5GVnGroupConfiguration = new(
			models.Udm_PP_5GVnGroupConfiguration,
		)
...
/*
Class5GVNGroupModificationApiService modify a 5G VN Group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ExtGroupId - External Identifier of the group
 * @param RequestBody -
...
type Modify5GVNGroupRequest struct {
	ExtGroupId        *string
	RequestBody       *models.Udm_PP_5GVnGroupConfiguration
...
func (a *Class5GVNGroupModificationApiService) Modify5GVNGroup(
	ctx context.Context,
