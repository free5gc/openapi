...
func (a *GPSIToSUPITranslationOrSUPIToGPSITranslationApiService) GetSupiOrGpsi(ctx context.Context, request *GetSupiOrGpsiRequest) (*GetSupiOrGpsiResponse, error) {
	var (
	...
	if request.AfServiceId != nil {
		localVarQueryParams.Add("af-service-id", openapi.ParameterToString(request.AfServiceId, "multi"))
	}
	...
	if request.RequestedGpsiType != nil {
		localVarQueryParams.Add("requested-gpsi-type", openapi.ParameterToString(request.RequestedGpsiType, "multi"))
	}
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.IdTranslationResult, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
