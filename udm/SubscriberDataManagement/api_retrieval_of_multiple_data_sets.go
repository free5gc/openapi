...
func (a *RetrievalOfMultipleDataSetsApiService) GetDataSets(ctx context.Context, request *GetDataSetsRequest) (*GetDataSetsResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.UdmSdmSubscriptionDataSets, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
