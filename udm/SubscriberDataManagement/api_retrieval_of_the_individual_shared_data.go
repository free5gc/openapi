...
func (a *RetrievalOfTheIndividualSharedDataApiService) GetIndividualSharedData(ctx context.Context, request *GetIndividualSharedDataRequest) (*GetIndividualSharedDataResponse, error) {
	var (
