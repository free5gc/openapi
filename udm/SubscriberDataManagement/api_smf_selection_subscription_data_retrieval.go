...
func (a *SMFSelectionSubscriptionDataRetrievalApiService) GetSmfSelData(ctx context.Context, request *GetSmfSelDataRequest) (*GetSmfSelDataResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.SmfSelectionSubscriptionData, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
