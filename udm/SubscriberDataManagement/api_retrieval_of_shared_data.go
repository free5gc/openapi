...
func (a *RetrievalOfSharedDataApiService) GetSharedData(ctx context.Context, request *GetSharedDataRequest) (*GetSharedDataResponse, error) {
	...
	if request.SupportedFeatures != nil {
		localVarQueryParams.Add("supportedFeatures", openapi.ParameterToString(request.SupportedFeatures, "multi"))
	}
	if request.SupportedFeatures2 != nil {
		localVarQueryParams.Add("supported-features", openapi.ParameterToString(request.SupportedFeatures2, "multi"))
	}
