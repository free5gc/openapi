...
func (a *SliceSelectionSubscriptionDataRetrievalApiService) GetNSSAI(ctx context.Context, request *GetNSSAIRequest) (*GetNSSAIResponse, error) {
	var (
	...
	case 200:
		err = openapi.Deserialize(&localVarReturnValue.Nssai, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
		if err != nil {
			return nil, err
		}
