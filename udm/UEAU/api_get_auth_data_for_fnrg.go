...
type GetRgAuthDataResponse struct {
	Udm_UEAU_RgAuthCtx *models.Udm_UEAU_RgAuthCtx
}
...
func (a *GetAuthDataForFNRGApiService) GetRgAuthData(
	ctx context.Context,
	request *GetRgAuthDataRequest,
) (*GetRgAuthDataResponse, error) {
	var (
	...
	if request.AuthenticatedInd == nil {
		...
		err := openapi.AddQueryParams(&localVarQueryParams, "authenticated-ind", request.AuthenticatedInd, "multi")
		if err != nil {
			return nil, err
		}
	}
	...
	case 200:
		localVarReturnValue.Udm_UEAU_RgAuthCtx = new(models.Udm_UEAU_RgAuthCtx)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_UEAU_RgAuthCtx,
			localVarBody,
