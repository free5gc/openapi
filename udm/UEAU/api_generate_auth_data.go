...
type GenerateAuthDataRequest struct {
	SupiOrSuci  *string
	RequestBody *models.Udm_UEAU_AuthenticationInfoRequest
}
...
func (r *GenerateAuthDataRequest) SetRequestBody(
	RequestBody models.Udm_UEAU_AuthenticationInfoRequest,
) {
...
type GenerateAuthDataResponse struct {
	Udm_UEAU_AuthenticationInfoResult *models.Udm_UEAU_AuthenticationInfoResult
}
...
func (a *GenerateAuthDataApiService) GenerateAuthData(
	ctx context.Context,
	request *GenerateAuthDataRequest,
) (*GenerateAuthDataResponse, error) {
	var (
		...
		localVarReturnValue  GenerateAuthDataResponse
	)
	...
	case 200:
		localVarReturnValue.Udm_UEAU_AuthenticationInfoResult = new(
			models.Udm_UEAU_AuthenticationInfoResult,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Udm_UEAU_AuthenticationInfoResult,
			localVarBody,
