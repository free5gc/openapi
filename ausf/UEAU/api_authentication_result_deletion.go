...
func (r *Delete5gAkaAuthenticationResultRequest) SetAuthCtxId(
	AuthCtxId string,
) {
...
func (a *AuthenticationResultDeletionApiService) Delete5gAkaAuthenticationResult(
	ctx context.Context,
	request *Delete5gAkaAuthenticationResultRequest,
) (*Delete5gAkaAuthenticationResultResponse, error) {
	var (
...
func (a *AuthenticationResultDeletionApiService) DeleteEapAuthenticationResult(
	ctx context.Context,
	request *DeleteEapAuthenticationResultRequest,
) (*DeleteEapAuthenticationResultResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r *DeleteProSeAuthenticationResultRequest) SetAuthCtxId(
	AuthCtxId string,
) {
	r.AuthCtxId = &AuthCtxId
}
...
func (a *AuthenticationResultDeletionApiService) DeleteProSeAuthenticationResult(
	ctx context.Context,
	request *DeleteProSeAuthenticationResultRequest,
) (*DeleteProSeAuthenticationResultResponse, error) {
	var (
		localVarHTTPMethod   = strings.ToUpper("Delete")
		localVarPostBody     interface{}
		localVarFormFileName string
