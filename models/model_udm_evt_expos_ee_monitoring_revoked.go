...
type Udm_EvtExpos_EeMonitoringRevoked struct {
	...
	RevokedMonitoringEventList map[string]Udm_EvtExpos_MonitoringEvent `json:"revokedMonitoringEventList,omitempty" yaml:"revokedMonitoringEventList,omitempty" bson:"revokedMonitoringEventList,omitempty"`
