...
// Represents information to be sent in a location information request. It contains the requested
// information, i.e. current location, local time zone, RAT type, or serving node identity only.
