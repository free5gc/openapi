...
type Nrf_NFMgmt_NwdafCapability struct {
	...
	AnalyticsMetadataProvisioning bool `json:"analyticsMetadataProvisioning,omitempty" yaml:"analyticsMetadataProvisioning,omitempty" bson:"analyticsMetadataProvisioning,omitempty"`
}
