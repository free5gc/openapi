...
type Nrf_NFDisc_NoProfileMatchInfo struct {
	...
	QueryParamCombinationList []Nrf_NFDisc_QueryParamCombination `json:"queryParamCombinationList,omitempty" yaml:"queryParamCombinationList,omitempty" bson:"queryParamCombinationList,omitempty"`
}
