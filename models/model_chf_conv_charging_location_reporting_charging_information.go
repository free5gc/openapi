...
type Chf_ConvCharging_LocationReportingChargingInformation struct {
	LocationReportingMessageType int32 `json:"locationReportingMessageType,omitempty" yaml:"locationReportingMessageType,omitempty" bson:"locationReportingMessageType,omitempty"`
