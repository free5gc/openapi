...
// This data type is defined in the same way as the AfRoutingRequirement data type, but with the
// OpenAPI nullable property set to true and the spVal and tempVals attributes defined as removable.
