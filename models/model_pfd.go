...
type Pfd struct {
	...
	PfdId string `json:"pfdId" yaml:"pfdId" bson:"pfdId"`
	...
	FlowDescriptions []string `json:"flowDescriptions,omitempty" yaml:"flowDescriptions" bson:"flowDescriptions"`
	// Indicates a URL or a regular expression which is used to match the significant parts of the URL.
	Urls []string `json:"urls,omitempty" yaml:"urls" bson:"urls"`
	// Indicates an FQDN or a regular expression as a domain name matching criteria.
	DomainNames []string           `json:"domainNames,omitempty" yaml:"domainNames" bson:"domainNames"`
	DnProtocol  DomainNameProtocol `json:"dnProtocol,omitempty" yaml:"dnProtocol" bson:"dnProtocol"`
}
