...
type Udm_UEAU_ProSeAuthenticationInfoResult struct {
	...
	ProseAuthenticationVectors *Udm_UEAU_ProSeAuthenticationVectors `json:"proseAuthenticationVectors,omitempty" yaml:"proseAuthenticationVectors,omitempty" bson:"proseAuthenticationVectors,omitempty"`
