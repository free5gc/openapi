...
type CancelRelocateUEContextRequestBody struct {
	...
	BinaryDataGtpcMessage *multipart.RelatedContent `json:"binaryDataGtpcMessage,omitempty" multipart:"contentType:application/vnd.3gpp.gtpc" yaml:"binaryDataGtpcMessage,omitempty" bson:"binaryDataGtpcMessage,omitempty"`
}
