...
type PpData struct {
	CommunicationCharacteristics *CommunicationCharacteristics `json:"communicationCharacteristics,omitempty" yaml:"communicationCharacteristics" bson:"communicationCharacteristics,omitempty"`
	...
	ExpectedUeBehaviourParameters *ExpectedUeBehaviour `json:"expectedUeBehaviourParameters,omitempty" yaml:"expectedUeBehaviourParameters" bson:"expectedUeBehaviourParameters,omitempty"`
