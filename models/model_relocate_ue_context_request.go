...
type RelocateUeContextRequest struct {
	...
	BinaryDataForwardRelocationRequest []byte                 `json:"binaryDataForwardRelocationRequest,omitempty" yaml:"binaryDataForwardRelocationRequest" bson:"binaryDataForwardRelocationRequest,omitempty" multipart:"contentType:application/vnd.3gpp.gtpc,ref:JsonData.ForwardRelocationRequest.ContentId,omitempty"`
