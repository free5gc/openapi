...
// If the additionalPraId IE is present, this IE shall state the presence information of the UE for
// the individual PRA identified by the additionalPraId IE;  If the additionalPraId IE is not
// present, this IE shall state the presence information of the UE for the PRA identified by the
// praId IE.
