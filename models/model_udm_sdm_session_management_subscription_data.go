...
type Udm_SDM_SessionManagementSubscriptionData struct {
	...
	SharedDnnConfigurationsId string `json:"sharedDnnConfigurationsId,omitempty" yaml:"sharedDnnConfigurationsId,omitempty" bson:"sharedDnnConfigurationsId,omitempty"`
