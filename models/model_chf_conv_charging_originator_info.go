...
type Chf_ConvCharging_OriginatorInfo struct {
	...
	OriginatorReceivedAddress *Chf_ConvCharging_SMAddressInfo `json:"originatorReceivedAddress,omitempty" yaml:"originatorReceivedAddress,omitempty" bson:"originatorReceivedAddress,omitempty"`
