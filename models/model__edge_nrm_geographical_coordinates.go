...
type _EdgeNrm_GeographicalCoordinates struct {
	Lattitude int32 `json:"lattitude,omitempty" yaml:"lattitude,omitempty" bson:"lattitude,omitempty"`

	Longitude int32 `json:"longitude,omitempty" yaml:"longitude,omitempty" bson:"longitude,omitempty"`
}
