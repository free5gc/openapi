...
type Udr_DR_AuthenticationSubscription struct {
	...
	AuthenticationManagementField string `json:"authenticationManagementField,omitempty" yaml:"authenticationManagementField,omitempty" bson:"authenticationManagementField,omitempty"`
