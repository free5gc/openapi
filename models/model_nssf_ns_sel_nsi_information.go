...
// Contains the API URIs of NRF services to be used to discover NFs/services, subscribe to NF status
// changes and/or request access tokens within the selected Network Slice instance and optional the
