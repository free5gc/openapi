...
// Identifies the events the application subscribes to within an AM Policy Events Subscription
// subresource data. It may contain the notification of the already met events.
