...
type Chf_ConvCharging_PDUSessionInformation struct {
	...
	ChargingCharacteristicsSelectionMode Chf_ConvCharging_ChargingCharacteristicsSelectionMode `json:"chargingCharacteristicsSelectionMode,omitempty" yaml:"chargingCharacteristicsSelectionMode,omitempty" bson:"chargingCharacteristicsSelectionMode,omitempty"`
	...
	RedundantTransmissionType Chf_ConvCharging_RedundantTransmissionType `json:"redundantTransmissionType,omitempty" yaml:"redundantTransmissionType,omitempty" bson:"redundantTransmissionType,omitempty"`
	...
	CpCIoTOptimisationIndicator bool `json:"cpCIoTOptimisationIndicator,omitempty" yaml:"cpCIoTOptimisationIndicator,omitempty" bson:"cpCIoTOptimisationIndicator,omitempty"`

	Var5GSControlPlaneOnlyIndicator bool `json:"5GSControlPlaneOnlyIndicator,omitempty" yaml:"5GSControlPlaneOnlyIndicator,omitempty" bson:"5GSControlPlaneOnlyIndicator,omitempty"`

	SmallDataRateControlIndicator bool `json:"smallDataRateControlIndicator,omitempty" yaml:"smallDataRateControlIndicator,omitempty" bson:"smallDataRateControlIndicator,omitempty"`
