...
// When Snssai needs to be converted to string (e.g. when used in maps as key), the string shall be
// composed of one to three digits \"sst\" optionally followed by \"-\" and 6 hexadecimal digits
// \"sd\".
type Snssai struct {
