...
// This data type is defined in the same way as the 'PresenceInfo' data type, but with the OpenAPI
// 'nullable: true' property.  If the additionalPraId IE is present, this IE shall state the
// presence information of the UE for the individual PRA identified by the additionalPraId IE;  If
// the additionalPraId IE is not present, this IE shall state the presence information of the UE for
// the PRA identified by the praId IE.
