...
type NssfEventNotification struct {
	...
	AuthorizedNssaiAvailabilityData []AuthorizedNssaiAvailabilityData `json:"authorizedNssaiAvailabilityData" yaml:"authorizedNssaiAvailabilityData" bson:"authorizedNssaiAvailabilityData,omitempty"`
}
