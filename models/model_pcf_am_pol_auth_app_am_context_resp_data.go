...
// It represents a response to a modification or creation request of an Individual Application AM
// resource. It may contain the notification of the already met events.
