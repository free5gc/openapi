...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AMPolicyEventsSubscriptionDocumentApi = (*AMPolicyEventsSubscriptionDocumentApiService)(
		&c.common,
	)
	c.ApplicationAMContextsCollectionApi = (*ApplicationAMContextsCollectionApiService)(
		&c.common,
	)
	c.IndividualApplicationAMContextDocumentApi = (*IndividualApplicationAMContextDocumentApiService)(
		&c.common,
	)
