...
type CreateMBSAppSessionCtxtRequest struct {
	RequestBody *models.Pcf_MBSPolAuth_MbsAppSessionCtxt
}

func (r *CreateMBSAppSessionCtxtRequest) SetRequestBody(
	RequestBody models.Pcf_MBSPolAuth_MbsAppSessionCtxt,
) {
...
func (a *MBSApplicationSessionContextsCollectionApiService) CreateMBSAppSessionCtxt(
	ctx context.Context,
	request *CreateMBSAppSessionCtxtRequest,
) (*CreateMBSAppSessionCtxtResponse, error) {
	var (
