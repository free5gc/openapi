...
func (r *DeleteIndividualUEPolicyAssociationRequest) SetPolAssoId(
	PolAssoId string,
) {
...
func (a *IndividualUEPolicyAssociationDocumentApiService) DeleteIndividualUEPolicyAssociation(
	ctx context.Context,
	request *DeleteIndividualUEPolicyAssociationRequest,
) (*DeleteIndividualUEPolicyAssociationResponse, error) {
	var (
...
func (r *ReadIndividualUEPolicyAssociationRequest) SetPolAssoId(
	PolAssoId string,
) {
	r.PolAssoId = &PolAssoId
}
...
func (a *IndividualUEPolicyAssociationDocumentApiService) ReadIndividualUEPolicyAssociation(
	ctx context.Context,
	request *ReadIndividualUEPolicyAssociationRequest,
) (*ReadIndividualUEPolicyAssociationResponse, error) {
	var (
...
type ReportObservedEventTriggersForIndividualUEPolicyAssociationRequest struct {
	PolAssoId   *string
	RequestBody *models.Pcf_UEPolCtrl_PolicyAssociationUpdateRequest
}

func (r *ReportObservedEventTriggersForIndividualUEPolicyAssociationRequest) SetPolAssoId(
	PolAssoId string,
) {
	r.PolAssoId = &PolAssoId
}

func (r *ReportObservedEventTriggersForIndividualUEPolicyAssociationRequest) SetRequestBody(
	RequestBody models.Pcf_UEPolCtrl_PolicyAssociationUpdateRequest,
) {
...
type ReportObservedEventTriggersForIndividualUEPolicyAssociationResponse struct {
	Pcf_UEPolCtrl_PolicyUpdate *models.Pcf_UEPolCtrl_PolicyUpdate
}
...
func (a *IndividualUEPolicyAssociationDocumentApiService) ReportObservedEventTriggersForIndividualUEPolicyAssociation(
	ctx context.Context,
	request *ReportObservedEventTriggersForIndividualUEPolicyAssociationRequest,
) (*ReportObservedEventTriggersForIndividualUEPolicyAssociationResponse, error) {
	var (
	...
	switch localVarHTTPResponse.StatusCode {
	case 200:
		localVarReturnValue.Pcf_UEPolCtrl_PolicyUpdate = new(
			models.Pcf_UEPolCtrl_PolicyUpdate,
		)
		err = openapi.Deserialize(
			localVarReturnValue.Pcf_UEPolCtrl_PolicyUpdate,
			localVarBody,
			localVarHTTPResponse.Header.Get("Content-Type"),
		)
		if err != nil {
