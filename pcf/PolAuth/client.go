...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ApplicationSessionsCollectionApi = (*ApplicationSessionsCollectionApiService)(
		&c.common,
	)
	c.EventsSubscriptionDocumentApi = (*EventsSubscriptionDocumentApiService)(
		&c.common,
	)
	c.IndividualApplicationSessionContextDocumentApi = (*IndividualApplicationSessionContextDocumentApiService)(
		&c.common,
	)
	c.PCSCFRestorationIndicationApi = (*PCSCFRestorationIndicationApiService)(
		&c.common,
	)
