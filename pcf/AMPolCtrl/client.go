...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AMPolicyAssociationsCollectionApi = (*AMPolicyAssociationsCollectionApiService)(
		&c.common,
	)
	c.IndividualAMPolicyAssociationDocumentApi = (*IndividualAMPolicyAssociationDocumentApiService)(
		&c.common,
	)
